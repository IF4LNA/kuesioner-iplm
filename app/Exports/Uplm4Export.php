...
class Uplm4Export implements FromCollection, WithHeadings, WithMapping
{
    protected $jenis;
    protected $subjenis;
    protected $tahun;
    ...
    public function __construct(
        ...
        $this->currentTahun = $tahun ?: Pertanyaan::where('kategori', 'UPLM 4')->max('tahun') ?? date('Y');
        
        Log::info('Export UPLM4 initialized with parameters:', [
