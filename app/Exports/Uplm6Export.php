...
class Uplm6Export implements FromCollection, WithHeadings, WithMapping
{
    protected $jenis;
    protected $subjenis;
    protected $tahun;
    ...
    public function __construct(
        ...
        $this->currentTahun = $tahun ?: Pertanyaan::where('kategori', 'UPLM 6')->max('tahun') ?? date('Y');
        
        Log::info('Export UPLM6 initialized with parameters:', [
