...
@section('content')
    <div class="container mt-4">
        <h3 class="p-1">UPLM 4 Tingkat Kunjungan Masyarakat Perhari</h3>
        ...
        <div id="filterContainer" style="display: none;">
            ...
            <div class="mb-4">
                <form action="{{ route('uplm', $id) }}" method="GET">
                    <div class="row">
                        <div class="col-md-4">
                            <select name="tahun" id="tahun" class="form-select form-select-md"
        ...
        <!-- Export Excel -->
        <a href="{{ route('uplm.exportExcel', ['id' => 4, 'jenis' => request()->jenis, 'subjenis' => request()->subjenis, 'tahun' => request()->tahun]) }}"
            class="btn btn-success">
            <i class="fas fa-file-excel"></i> Export Excel
        </a>

        <!-- Export PDF -->
        <a href="{{ route('uplm.exportPdf', ['id' => 4, 'kategori' => 4, 'jenis' => request()->jenis, 'subjenis' => request()->subjenis, 'tahun' => request()->tahun]) }}"
