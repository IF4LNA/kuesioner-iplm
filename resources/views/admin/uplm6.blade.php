...
@section('content')
    <div class="container mt-4">
        ...
        <!-- Export Excel -->
        <a href="{{ route('uplm.exportExcel', ['id' => 6, 'jenis' => request()->jenis, 'subjenis' => request()->subjenis, 'tahun' => request()->tahun]) }}"
            class="btn btn-success">
            <i class="fas fa-file-excel"></i> Export Excel
        </a>

        <!-- Export PDF -->
        <a href="{{ route('uplm.exportPdf', ['id' => 6, 'kategori' => 6, 'jenis' => request()->jenis, 'subjenis' => request()->subjenis, 'tahun' => request()->tahun]) }}"
