    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            headers.forEach((header, index) => {
                const icon = header.querySelector('i'); // Ambil ikon untuk kolom tersebut
                ...
                header.addEventListener('click', () => {
                    ...
                    headers.forEach(h => {
                        ...
                        h.querySelector('i').style.visibility =
                        'hidden'; // Sembunyikan ikon pada kolom lainnya
                    });
                    ...
                    rows.sort((rowA, rowB) => {
                        ...
                        // Sorting untuk kolom lainnya (untuk kolom lain yang diperlukan)
                        return cellA.localeCompare(cellB) * direction;
                    });
